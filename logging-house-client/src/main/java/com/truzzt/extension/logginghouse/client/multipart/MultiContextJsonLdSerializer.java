 ...
 *       sovity GmbH - Adaption and changes
 *
 */
 ...
 */
public class MultiContextJsonLdSerializer<T> extends JsonSerializer<T> {
    private final Class<T> type;
    private final Object contextInformation;

    private static final ThreadLocal<Integer> CURRENT_RECURSION_DEPTH = ThreadLocal.withInitial(() -> 0);

    public MultiContextJsonLdSerializer(Class<T> type, Object contextInformation) {
        this.type = type;
