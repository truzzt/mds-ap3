...
import static com.truzzt.extension.logginghouse.client.tests.TestDataBuilder.buildInitialTransferProcessAsJSON;
...
class MessageWorkerTest extends BaseUnitTest {
    ...
    void process_successContractAgreement() {
        ...
        when(dispatcherRegistry.dispatch(eq(Object.class), any(RemoteMessage.class)))
                .thenReturn(CompletableFuture.completedFuture(StatusResult.success(CREATE_PROCESS_RESPONSE)));
    ...
    void createProcess_success() {
        ...
        result.onSuccess(msg -> assertEquals(CREATE_PROCESS_RESPONSE, msg.toString()));
